    ...
    <Container>
      <Grid container spacing={2}>
        <Grid item md={12} sm={12} xs={12}>
          <SectionHeader title={getString("ja", "footer", "terms")} />
        </Grid>
        <Grid item md={12} sm={12} xs={12}>
          <Card>
            <CardContent>
              <Typography variant="subtitle1" gutterBottom>
                <b>Welcome to VOICE-INFO!</b>
              </Typography>
              <Typography variant="body1" align="justify" gutterBottom>
                These terms and conditions outline the rules and regulations for
                the use of VOICE-INFO's Website, located at
                http://voice-info.firebaseapp.com.
              </Typography>
              <Typography variant="body1" align="justify" gutterBottom>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use VOICE-INFO if you do not
              ...
              <Typography variant="body1" align="justify">
                We employ the use of cookies. By accessing VOICE-INFO, you
                agreed to use cookies in agreement with the VOICE-INFO's Privacy
              ...
              <Typography variant="body1" align="justify">
                Unless otherwise stated, VOICE-INFO and/or its licensors own the
                intellectual property rights for all material on VOICE-INFO. All
                intellectual property rights are reserved. You may access this
                from VOICE-INFO for your own personal use subjected to
              ...
              <ul>
                <li>Republish material from VOICE-INFO</li>
                <li>Sell, rent or sub-license material from VOICE-INFO</li>
                <li>Reproduce, duplicate or copy material from VOICE-INFO</li>
                <li>Redistribute content from VOICE-INFO</li>
              </ul>
              <Typography variant="body1" align="justify">
                Parts of this website offer an opportunity for users to post and
                exchange opinions and information in certain areas of the
                website. VOICE-INFO does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of VOICE-INFO,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, VOICE-INFO shall not be liable for
                ...
                <br />
                <br />
                VOICE-INFO reserves the right to monitor all Comments and to
              ...
              <Typography variant="body1" align="justify">
                You hereby grant VOICE-INFO a non-exclusive license to use,
              ...
              <Typography variant="body1" align="justify">
                ...
                of VOICE-INFO; and (d) the link is in the context of general
                ...
                by sending an e-mail to VOICE-INFO. Please include your name,
              ...
              <Typography variant="subtitle1" gutterBottom>
                No use of VOICE-INFO's logo or other artwork will be allowed for
